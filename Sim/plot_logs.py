...
if __name__ == "__main__":
    drones = [
        (
            "Sim/logs/drone_1_2026-05-16-14-15.csv",
            "Sim/logs/drone_velocity_1_2026-05-16-14-15.csv",
            "Drone 1"
        ),
        (
            "Sim/logs/drone_2_2026-05-16-14-15.csv",
            "Sim/logs/drone_velocity_2_2026-05-16-14-15.csv",
            "Drone 2"
        ),
        (
            "Sim/logs/drone_3_2026-05-16-14-15.csv",
            "Sim/logs/drone_velocity_3_2026-05-16-14-15.csv",
            "Drone 3"
        )
    ]
