...
import test_multi_ranger_takeoff as test_multi_ranger_takeoff
...
if __name__ == "__main__":
    ...
    p2 = Process(target=test_multi_ranger_takeoff.wrapper_sync, args=(queues_commande,queues_etat_reel,queues_lidar,))
